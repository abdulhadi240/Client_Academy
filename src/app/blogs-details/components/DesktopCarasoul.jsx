...
export default class DesktopCarasoul extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="flex flex-col items-center justify-center max-w-4xl gap-4 mt-10 mb-10 overflow-hidden text-center ">
        {/* Carousel Component */}
        <Carousel
        ...
        >
          {/* Slide 1 with cities */}
          <div className="flex justify-center max-w-3xl gap-4 pb-4 pl-4 mx-auto text-start">
          <Course_card/>
          <Course_card/>
          </div>
